    ...
    return <Row>
      <Col>
        <Card>
          <Card.Body>
            <Card.Title>
              {eventRegistration.StudentProfile.firstName} {eventRegistration.StudentProfile.lastName}
            </Card.Title>
            <Card.Text>Registered on {new Date(eventRegistration.createdAt).toLocaleString('en-US', {dateStyle: 'full',})}</Card.Text>
            <Card.Text>
