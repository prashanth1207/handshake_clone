...
function CategorySvg() {
  return (
    <svg aria-hidden="true" data-prefix="fas" data-icon="briefcase" className="svg-inline--fa fa-briefcase fa-w-16 icon" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
