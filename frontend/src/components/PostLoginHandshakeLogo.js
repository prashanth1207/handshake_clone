...
export default function PostLoginHandshakeLogo(props) {
  return (
    <a href="/" aria-label="Homepage">
                          <svg xmlns="http://www.w3.org/2000/svg" id="logo-icon" viewBox="0 0 80.1 96.1" class="style__logo-icon___1eROG" width="32" height="32">
                              <title>Handshake</title>
                              <path class="style__logo-icon-content___1-wtb" d="
